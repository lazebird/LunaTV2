...
import { API_CONFIG, ApiSite, getConfig } from '@/frontend/lib/config';
import { getCachedSearchPage, setCachedSearchPage } from '@/frontend/lib/search-cache';
import { SearchResult } from '@/frontend/lib/types';
import { cleanHtmlTags } from '@/frontend/lib/utils';
